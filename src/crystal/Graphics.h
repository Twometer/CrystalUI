...
namespace crystal {
    ...
    public:
        Graphics(Vao *vao, MeshBuilder *builder, BasicShader *guiShader, TexturedShader *texturedShader,
        ...
        void
        draw_centered_text(const std::string &text, glm::vec2 position, float size = 1.0f, glm::vec4 color = WHITE);
